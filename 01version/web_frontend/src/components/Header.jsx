    ...
    <header className="w-full bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-3 sticky top-0 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between">
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                  ...
                  <button
                    ...
                    className="w-full flex items-center space-x-2 px-4 py-2 text-left text-gray-800 hover:bg-green-50 hover:text-green-600 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center space-x-2 px-4 py-2 text-left text-gray-800 hover:bg-purple-50 hover:text-purple-600 transition-colors"
                  >
          ...
          {/* Mobile Menu Button */}
          <button
            className="lg:hidden p-2 rounded-md text-gray-600 hover:text-cyan-600 hover:bg-gray-100 focus:outline-none"
